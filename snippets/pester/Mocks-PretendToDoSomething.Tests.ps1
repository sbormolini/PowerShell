...
. .\Invoke-PretendToDoSomething.ps1
...
Describe 'Unit Tests' -Tag 'Unit' {
    ...
    $aTestResult = Invoke-PretendToDoSomething $aFileThatDoesntExist -Verbose
...
Describe 'Integration Tests' -Tag 'Integration' {
    ...
    $aTestResult = Invoke-PretendToDoSomething $myTestData
    It 'Returns True if file didnt exist and processed OK' {
        $aTestResult | Should -BeTrue
    }
...
Describe 'Acceptance Tests' -Tag 'Acceptance' {
    ...
    # Test using a file name that won't exist
    $aTestResult = Invoke-PretendToDoSomething $testFilePath
    It 'Returns True if file didnt exist and processed OK' {
        $aTestResult | Should -BeTrue
    }
